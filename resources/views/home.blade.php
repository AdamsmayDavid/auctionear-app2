          ...
          <h1 class="text-center" style="color:#FF6C22;" >VEHICLE AVAILABLE</h1>
            <div class="row gy-3 mt-4">
              <div class="col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="d-grid">
                  <a href="/biddersMotorcycle" class="btn mt-2">MOTORCYCLE</a>
                </div>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-6">
                <img src="assets/images/red.jpg" class="img-fluid" />
                ...
                <div class="d-grid">
                  <a href="/biddersSedan" class="btn mt-2  mb-5">SEDAN</a>
                </div>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-6">
                <img src="assets/images/red.jpg" class="img-fluid" />
                ...
                <div class="d-grid">
                  <a href="/biddersSuv" class="btn mt-2 ">SUV</a>
                </div>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-6 ">
                <img src="assets/images/red.jpg" class="img-fluid" />
                ...
                <div class="d-grid mb-5">
                  <a href="/biddersVan" class="btn mt-2 ">VAN</a>
                </div>
              </div>
            </div>
          </div>
